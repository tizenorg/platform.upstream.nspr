...
**************************************************************************
*/
__attribute__ ((visibility ("default"))) NSPR_API(PRInt32) PR_Select(
...
__attribute__ ((visibility ("default"))) NSPR_API(PRInt32)     PR_FD_ISSET(PRFileDesc *fd, PR_fd_set *set);
NSPR_API(void)        PR_FD_NSET(PROsfd osfd, PR_fd_set *set);
NSPR_API(void)        PR_FD_NCLR(PROsfd osfd, PR_fd_set *set);
__attribute__ ((visibility ("default"))) NSPR_API(PRInt32)     PR_FD_NISSET(PROsfd osfd, PR_fd_set *set);
...
__attribute__ ((visibility ("default"))) NSPR_API(PRInt32) PR_GetSysfdTableMax(void);

__attribute__ ((visibility ("default"))) NSPR_API(PRInt32) PR_SetSysfdTableSize(PRIntn table_size);

#ifndef NO_NSPR_10_SUPPORT
#include <sys/stat.h>

__attribute__ ((visibility ("default"))) NSPR_API(PRInt32) PR_Stat(const char *path, struct stat *buf);
